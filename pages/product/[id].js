...
const Product = ({item}) => {
   ...
   return (  
    ...
    <a className="btn btn-light mt-3 mx-2" href="https://api.whatsapp.com/send/?phone=966501513551&text&app_absent=0"><img className="whats" src="/WhatsApp.svg.png"  alt="" />تواصل واتساب</a>
